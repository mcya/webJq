...
if(_99.text){
//$("<span class=\"l-btn-text\"></span>").html(_99.text).appendTo(_9a); XW优化
$("<span class=\"l-btn-text\">" + _99.text + "</span>").appendTo(_9a);
}else{
...
var _ae=_ad.options;
var bb=_ad.bb={};
//var _af=$(_ac).addClass("pagination").html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr></tr></table>"); XW优化
var _af=$(_ac).addClass("pagination")[0].innerHTML="<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr></tr></table>";
var tr=_af.find("tr");
...
if(_b2=="manual"){
//$("<span style=\"padding-left:6px;\"></span>").html(_ae.beforePageText).appendTo(tr).wrap("<td></td>"); XW优化
$("<span style=\"padding-left:6px;\">"+_ae.beforePageText+"</span>").appendTo(tr).wrap("<td></td>");
...
//$(_bd).find("div.pagination-info").html(_c4); XW优化
...
//$(_1df).html("<div class=\"progressbar-text\"></div><div class=\"progressbar-value\"><div class=\"progressbar-text\"></div></div>"); XW优化
...
//$(this).find("div.progressbar-text").html(text); XW优化
...
//_204.tip.children(".tooltip-content").html(cc); XW优化
_204.tip.children(".tooltip-content")[0].innerHTML=cc; 
...
if(opts.content){
$(_221).panel("clear");
//$(_221).html(opts.content); XW优化
$(_221)[0].innerHTML=opts.content;
$.parser.parse($(_221));
}
function _224(){
...
_228.empty();
//var _229=$("<div class=\"panel-title\"></div>").html(opts.title).appendTo(_228); XW优化
var _229=$("<div class=\"panel-title\">"+opts.title+"</div>").appendTo(_228);
if(opts.iconCls){
...
//$(_22d).html($("<div class=\"panel-loading\"></div>").html(opts.loadingMessage)); XW优化
$(_22d)[0].innerHTML="<div class=\"panel-loading\">"+opts.loadingMessage+"</div>";
}
opts.loader.call(_22d,_230,function(data){
var _231=opts.extractor.call(_22d,data);
//$(_22d).html(_231); XW优化
$(_22d)[0].innerHTML=_231;
$.parser.parse($(_22d));
...
//$(_255).panel("header").find("div.panel-title").html(_256); XW优化
$(_255).panel("header").find("div.panel-title")[0].innerHTML=_256;
};
var _257=null;
...
//item.empty().append($("<div class=\"menu-text\"></div>").html(text)); XW优化
item.empty().append($("<div class=\"menu-text\">"+text+"</div>"));
if(_3ff.iconCls){
...
//$("<div class=\"menu-text\"></div>").html(_421.text).appendTo(item); XW优化
$("<div class=\"menu-text\">"+_421.text+"</div>").appendTo(item);
}
if(_421.iconCls){
//$("<div class=\"menu-icon\"></div>").addClass(_421.iconCls).appendTo(item); XW优化
$("<div class=\"menu-icon "+_421.iconCls+"\"></div>").appendTo(item);
}
if(_421.id){
...
return jq.each(function(){
//$(_431.target).children("div.menu-text").html(_431.text); XW优化
$(_431.target).children("div.menu-text")[0].innerHTML=_431.text;
});
},setIcon:function(jq,_432){
return jq.each(function(){
$(_432.target).children("div.menu-icon").remove();
if(_432.iconCls){
//$("<div class=\"menu-icon\"></div>").addClass(_432.iconCls).appendTo(_432.target); XW优化
...
//var on=_468.find(".switchbutton-on").html(opts.onText); XW优化
var on=_468.find(".switchbutton-on")[0].innerHTML=opts.onText;
//var off=_468.find(".switchbutton-off").html(opts.offText); XW优化
var off=_468.find(".switchbutton-off")[0].innerHTML=opts.offText;
//var _469=_468.find(".switchbutton-handle").html(opts.handleText); XW优化
var _469=_468.find(".switchbutton-handle")[0].innerHTML=opts.handleText;
if(opts.reversed){
off.prependTo(_468);
on.insertAfter(_469);
}else{
...
function init(_573){
//$(_573).addClass("calendar").html("<div class=\"calendar-header\">"+"<div class=\"calendar-nav calendar-prevmonth\"></div>"+"<div class=\"calendar-nav calendar-nextmonth\"></div>"+"<div class=\"calendar-nav calendar-prevyear\"></div>"+"<div class=\"calendar-nav calendar-nextyear\"></div>"+"<div class=\"calendar-title\">"+"<span class=\"calendar-text\"></span>"+"</div>"+"</div>"+"<div class=\"calendar-body\">"+"<div class=\"calendar-menu\">"+"<div class=\"calendar-menu-year-inner\">"+"<span class=\"calendar-nav calendar-menu-prev\"></span>"+"<span><input class=\"calendar-menu-year\" type=\"text\"></input></span>"+"<span class=\"calendar-nav calendar-menu-next\"></span>"+"</div>"+"<div class=\"calendar-menu-month-inner\">"+"</div>"+"</div>"+"</div>"); XW优化
$(_573).addClass("calendar")[0].innerHTML="<div class=\"calendar-header\"><div class=\"calendar-nav calendar-prevmonth\"></div><div class=\"calendar-nav calendar-nextmonth\"></div><div class=\"calendar-nav calendar-prevyear\"></div><div class=\"calendar-nav calendar-nextyear\"></div><div class=\"calendar-title\"><span class=\"calendar-text\"></span></div></div><div class=\"calendar-body\"><div class=\"calendar-menu\"><div class=\"calendar-menu-year-inner\"><span class=\"calendar-nav calendar-menu-prev\"></span><span><input class=\"calendar-menu-year\" type=\"text\"></input></span><span class=\"calendar-nav calendar-menu-next\"></span></div><div class=\"calendar-menu-month-inner\"></div></div></div>";
...
for(var j=0;j<4;j++){
//$("<td class=\"calendar-nav calendar-menu-month\"></td>").html(opts.months[idx++]).attr("abbr",idx).appendTo(tr); XW优化
$("<td class=\"calendar-nav calendar-menu-month\">"+opts.months[idx++]+"</td>").attr("abbr",idx).appendTo(tr);
}
}
}
...
//$(_58f).find(".calendar-title span").html(opts.months[opts.month-1]+" "+opts.year); XW优化
$(_58f).find(".calendar-title span")[0].innerHTML=opts.months[opts.month-1]+" "+opts.year;
...
//$("<div class=\"datagrid-header-check\"></div>").html("<input type=\"checkbox\"/>").appendTo(td); XW优化
$("<div class=\"datagrid-header-check\"><input type=\"checkbox\"/></div>").appendTo(td);
}else{
if(col.field){
td.attr("field",col.field);
td.append("<div class=\"datagrid-cell\"><span></span><span class=\"datagrid-sort-icon\"></span></div>");
//td.find("span:first").html(col.title); XW优化
...
//$("<div class=\"datagrid-cell-group\"></div>").html(col.title).appendTo(td); XW优化
...
//var msg=$("<div class=\"datagrid-mask-msg\" style=\"display:block;left:50%\"></div>").html(opts.loadMsg).appendTo(_790); XW优化
var msg=$("<div class=\"datagrid-mask-msg\" style=\"display:block;left:50%\">"+opts.loadMsg+"</div>").appendTo(_790);
msg._outerHeight(40);
...
//$(_7b9).html(this.renderTable(_7b8,0,rows,_7ba)); XW优化
...
//tr.find("div.datagrid-cell-rownumber").html(_7e9); XW优化
tr.find("div.datagrid-cell-rownumber")[0].innerHTML=_7e9;
}
if(opts.striped){
...
//tr.find("div.datagrid-cell-rownumber").html(_7f5); XW优化
tr.find("div.datagrid-cell-rownumber")[0].innerHTML=_7f5;
}
if(opts.striped){
tr.removeClass("datagrid-row-alt").addClass((i-1)%2?"datagrid-row-alt":"");
}
...
if(type=="checked"){
//return (_804==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-checked") XW优化
return (_804==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row>td>div.datagrid-cell-check>input:checked").parent().parent().parent();
}else{
if(type=="editing"){
...
//$(_84a).html(_84c.join("")); XW优化
$(_84a)[0].innerHTML=_84c.join("");
...
//$(_939).html(_93c.join("")); XW优化
$(_939)[0].innerHTML=_93c.join("");
...
tr.attr("style",_949||"");
//tr.find("div.datagrid-cell-rownumber").html(_94f); XW优化
tr.find("div.datagrid-cell-rownumber")[0].innerHTML=_94f;
if(_950){
tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
if(_94b!=id){
...
//$(_97a).html(_97d.join("")); XW优化
$(_97a)[0].innerHTML=_97d.join("");
}else{
//$(_97a).html(this.renderTable(_979,0,_97c.data.rows,_97b)); XW优化
$(_97a)[0].innerHTML=this.renderTable(_979,0,_97c.data.rows,_97b);
}
...
//_a0f.show().html(g.html()); XW优化
_a0f.show()[0].innerHTML=g.html();
return false;
}
});
}
...
//$(_a25).html(dd.join("")); XW优化
$(_a25)[0].innerHTML=dd.join("");
}};
...
//var t=$("<a class=\"datebox-button-a\" href=\"javascript:void(0)\"></a>").html($.isFunction(btn.text)?btn.text(_aa0):btn.text).appendTo(td); XW优化
var t=$("<a class=\"datebox-button-a\" href=\"javascript:void(0)\">"+($.isFunction(btn.text)?btn.text(_aa0):btn.text)+"</a>").appendTo(td);
